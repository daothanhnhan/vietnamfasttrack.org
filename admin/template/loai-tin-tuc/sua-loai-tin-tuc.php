...
<?php
    if (isset($_POST['send_edit_lang'])) {
        ...
        $lang_vn_url = $_POST['lang']['vn']['friendly_url'];
        $sql_lang_vn = "UPDATE newstag_languages SET lang_newstag_name = '$lang_vn_name', lang_newstag_des = '$lang_vn_des', friendly_url = '$lang_vn_url' WHERE languages_code = 'vn' And newstag_id = $newstag_id";
        ...
        $lang_en_url = $_POST['lang']['en']['friendly_url'];
        $sql_lang_en = "UPDATE newstag_languages SET lang_newstag_name = '$lang_en_name', lang_newstag_des = '$lang_en_des', friendly_url = '$lang_en_url' WHERE languages_code = 'en' And newstag_id = $newstag_id";
                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" value="<?= $rowDetailLang['lang_newstag_name'];?>" name="lang[<?= $lang['languages_code']?>][lang_newstag_name]" id="news_name_<?= $lang['languages_code']?>_tag" onkeyup="news<?php echo $lang['languages_code'];?>_tag()"/>
                                        ...
                                        <input type="text" class="txtNCP1" value="<?= $rowDetailLang['friendly_url'];?>" name="lang[<?= $lang['languages_code']?>][friendly_url]" id="url_<?= $lang['languages_code']?>_tag" />
                                    </div>
                                <?php
                                }
                            ?>
...
<script type="text/javascript">
    function newsvn_tag () {
        ...
        title = document.getElementById("news_name_vn_tag").value;
        ...
        document.getElementById('url_vn_tag').value = slug;
        // document.getElementById('title_seo').value = title;
    }
    ...
    function newsen_tag () {
        ...
        //alert ("a");
        //Lấy text từ thẻ input title 
        title = document.getElementById("news_name_en_tag").value;
        // document.getElementById('title_seo').value = title;
        //Đổi chữ hoa thành chữ thường
        slug = title.toLowerCase();
        ...
        slug = slug.replace(/\@\-|\-\@|\@/gi, '');
        //In slug ra textbox có id “slug”
        document.getElementById('url_en_tag').value = slug;
        // document.getElementById('title_seo').value = title;
    }
</script>
