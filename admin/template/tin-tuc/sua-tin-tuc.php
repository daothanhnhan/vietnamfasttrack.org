<?php 
    ...
    $list_tag = $action->getList('newstag','','','newstag_id','desc','','','');
    ...
    $newstag_arr = explode(',', $row['newstag_arr']);//var_dump($newstag_arr);die;
?>
                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" name="lang[<?= $lang['languages_code']?>][friendly_url]" id="url_<?= $lang['languages_code']?>" value="<?= $rowDetailLang['friendly_url'];?>" >
                                    </div>
                                <?php
                                }
                            ?>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="subColContent">
                ...
                <select name="newstag_id[]" class="selectpicker" multiple>                
                 <?php 
                    foreach ($list_tag as $item) {
                        if (in_array($item['newstag_id'], $newstag_arr)) {
                            echo '<option value="'.$item['newstag_id'].'" selected>'.$item['newstag_name'].'</option>';
                        } else {
                            echo '<option value="'.$item['newstag_id'].'">'.$item['newstag_name'].'</option>';
                        }
                    }
                 ?>
                </select>
