   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiissssssssssssssssissssi');
   ...
   //          }
	...
	/*----------------- Trang nội dung -------------------*/
		...
		public function deletePage(){
			...
			if ($page_id == 56) {
				echo json_encode(array('error'=>'Mục này không được xóa.'));die;
			}
	...
	/*------------------ Tin tức -------------------*/
		...
		public function addNews(){
			...
			if (isset($_POST['newstag_id'])) {
				// $newstag_id = serialize($_POST['newstag_id']);
				$newstag_id = "";
				$arr_newstag = $_POST['newstag_id'];
				foreach ($arr_newstag as $item) {
					$newstag_id .= $item . ',';
				}
			} else {
				$newstag_id = '';
