        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    case 'visa':
                        include_once('template/visa.php');
                        break;

                    case 'arrival':
                        include_once("template/arrival_only.php");
                        break;
                    case 'departure':
                        include_once("template/departure_only.php");
                        break;
                    case 'arrival_departure':
                        include_once("template/arrival_departure.php");
                        break;
                    case 'connection_transit':
                        include_once("template/connection_transit.php");
                        break;

                    case 'customer':
                        include_once("template/book/customer.php");
                        break;

                    case 'book':
                        include_once("template/book/book.php");
                        break;
                    ///////////// Default /////////////////
                    default:
