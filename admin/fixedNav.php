        ...
        <ul class="listMenuFL">
            ...
            <!-- <li><a href="index.php?page=tai-khoan-user" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'tai-khoan-user' || $_GET["page"] == 'sua-tai-khoan-user') {
                       echo 'sltMenu';
                   } ?>" ><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tài khoản user</a></li> -->
           ...
           <li><a href="index.php?page=bai-viet" title=""
            ...
            <li><a href="index.php?page=danh-muc-tin-tuc" title=""
             ...
             <!-- tab loại tin tức -->
            <li><a href="index.php?page=loai-tin-tuc" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'loai-tin-tuc' || $_GET["page"] == 'sua-loai-tin-tuc' || $_GET["page"] == 'them-loai-tin-tuc') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Loại
                    bài Post</a></li>
          ...
          <!--  <li><a href="index.php?page=danh-muc-dich-vu" title=""
           ...
           <!--  <li><a href="index.php?page=dich-vu" title=""
            ...
            <li><a href="index.php?page=trinh-don" title=""
             ...
             <li><a href="index.php?page=visa" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Visa</a>
            </li>

            <li><a href="index.php?page=arrival" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Arrival Only</a>
            </li>

            <li><a href="index.php?page=departure" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Departure Only</a>
            </li>

            <li><a href="index.php?page=arrival_departure" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Arrival & Departure</a>
            </li>

            <li><a href="index.php?page=connection_transit" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Connection or Transit</a>
            </li>

            <li><a href="index.php?page=customer" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Customer</a>
            </li>
            ...
            <!-- <li><a href="index.php?page=dang-ky" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'dang-ky' || $_GET["page"] == 'them-dang-ky' || $_GET["page"] == 'sua-dang-ky') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Bảng
                    đăng ký</a></li> -->
    ...
    <div class="rightFixedTop">
        ...
        if (isset($_GET["page"])) {
            switch ($_GET["page"]) {
                ...
                /*--------------- Loại tin tức -------------------*/
                 case "loai-tin-tuc":
                    echo "<a href='index.php?page=them-loai-tin-tuc' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;

                case "them-loai-tin-tuc":
                    echo "<a class='btnTop btnAddTop' href='index.php?page=loai-tin-tuc'>Quay lại</a>";
                    echo "<a class='btnTop btnAddTop' href='index.php?page=them-loai-tin-tuc'>Thêm mới</a>";
                    break;
