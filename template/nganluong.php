...
if(@$_POST['nlpayment']) {
	...
	$total_amount= $_POST['total_amount'];
	 ...
	 $return_url ='http://cms.thietkewebsitegbvn.com/payment-success';
...
<style type="text/css">
	...
	<form  name="NLpayBank" action="#" method="post" id="nganluong">	
		<table style="clear:both;width:500px;padding-left:46px;margin: 0px;"> 
			...
			<tr><td>Số tiền thanh toán: </td>
				<td>
					 <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="<?= $_SESSION['price_gbvn'] ?>" readonly>
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
