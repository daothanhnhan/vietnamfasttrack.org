...
class action_email 
{
        function email_send ($email_to, $title = "", $content = "") {
                $nFrom = "Vietnam Fast Track Team";    //mail duoc gui tu dau, thuong de ten cong ty ban
                $mFrom = 'contact@vietnamfasttrack.org';  //dia chi email cua ban 
                // $mPass = 'URGS3xuuVKfg6SYN';       //mat khau email cua ban
                $mPass = 'songbienxanh@';       //mat khau email cua ban
                ...
                $mail->AddReplyTo('contact@vietnamfasttrack.org', 'vietnamfasttrack'); //khi nguoi dung phan hoi se duoc gui den email nay
