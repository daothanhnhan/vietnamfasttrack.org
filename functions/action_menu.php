    ...
    public function showMenu_byMultiLevel_mainMenuTraiCam($list_menu,$valParent_menu = 0,$lang, $level = 0){
        ...
        if ($cate_child) {
            ...
            foreach ($cate_child as $key => $item) {
                ...
                if($level == 0 && $row[$this->nameColTitle_menuLanguage] == "Book online or by E-mail")
                  echo '<li class="bookonline item_main_menu_'.($level+1).'">'; 
                else
                    if($level == 0 && $row[$this->nameColTitle_menuLanguage] != "Trang chủ")
                        echo '<li class="item_main_menu_'.($level+1).'">'; 
                    else    
        ...
        //     echo '<li><a href="javascript:;" id="Chinese" onclick="translateLanguage(this.id);">
        //     <img src="/images/flag/china.png" alt="" width="50" /></a> </li>
        // <li><a href="javascript:;" id="English" onclick="translateLanguage(this.id);">
        //     <img src="/images/flag/english.png" alt="" width="50" /></a> </li>';
            echo '</ul>';        
        } 
    }
    /*-----------------------------*/
